...
export declare const EmailConditionInputSchema: z.ZodEffects<z.ZodUnion<[z.ZodObject<{
    ...
    field: z.ZodUnion<[z.ZodUndefined, z.ZodLiteral<APIFieldName.EMAIL>]>;
}, "strip", z.ZodTypeAny, {
    operator: APIOperatorType.ANY;
    targetValue?: any;
    field?: APIFieldName.EMAIL | undefined;
}, {
    operator: APIOperatorType.ANY;
    targetValue?: any;
    field?: APIFieldName.EMAIL | undefined;
...
export type EmailConditionInput = OmitUndefined<z.infer<typeof EmailConditionInputSchema>>;
