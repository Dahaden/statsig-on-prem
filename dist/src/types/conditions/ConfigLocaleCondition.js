...
exports.LocaleConditionInputSchema = void 0;
...
var AllowedFields = zod_1.z.union([
    ...
    zod_1.z.literal(ConfigSpecs_1.APIFieldName.LOCALE) /* From JSON */,
]);
exports.LocaleConditionInputSchema = (0, ConfigCondition_1.SupportedOperations)(AllowedOperators, AllowedValues, AllowedFields);
var ConfigLocaleCondition = /** @class */ (function (_super) {
    __extends(ConfigLocaleCondition, _super);
    function ConfigLocaleCondition(input) {
        var _this = _super.call(this) || this;
        exports.LocaleConditionInputSchema.parse(input);
        _this.operator = input.operator;
        _this.targetValue = input.targetValue;
        return _this;
    }
    ConfigLocaleCondition.prototype.getConfigConditionType = function () {
        return ConfigCondition_1.ConfigConditionType.LOCALE;
    };
    ConfigLocaleCondition.prototype.getAPIConditionType = function () {
        return ConfigSpecs_1.APIConditionType.USER_FIELD;
    };
    ConfigLocaleCondition.prototype.getIDType = function () {
        return "userID";
    };
    ConfigLocaleCondition.prototype.getOperator = function () {
        return this.operator;
    };
    ConfigLocaleCondition.prototype.getField = function () {
        return ConfigSpecs_1.APIFieldName.LOCALE;
    };
    ConfigLocaleCondition.prototype.getTargetValue = function () {
        return this.targetValue;
    };
    return ConfigLocaleCondition;
}(ConfigCondition_1.default));
exports.default = ConfigLocaleCondition;
