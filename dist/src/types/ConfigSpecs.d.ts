...
export declare enum APIConfigType {
    DYNAMIC_CONFIG = "dynamic_config",
    FEATURE_GATE = "feature_gate"
}
export declare enum APIEntityType {
    AUTOTUNE = "autotune",
    DYNAMIC_CONFIG = "dynamic_config",
...
export declare enum APIConditionType {
    FALLBACK = "fallback",
    PUBLIC = "public",
    IP_BASED = "ip_based",
    UA_BASED = "ua_based",
...
export declare enum APIFieldName {
...
export declare enum APIOperatorType {
    ANY = "any",
    NONE = "none",
    GT = "gt",
    LT = "lt",
